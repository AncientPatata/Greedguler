...
Welcome to Greedguler's documentation!
======================================
...
Moreover, you need to replace the backblaze API id and API key in the `Asure batch repo <https://github.com/AncientPatata/azure_batch_greedguler/>`_ with your own (I only put in some mock ones).
